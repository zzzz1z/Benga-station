    ...
    return (
        <div className="flex flex-col gap-y-3 px-4 py-4">
            ...
            <div
                ...
                className="border border-red-900/20 bg-white/[0.02] flex items-center justify-between p-4 cursor-pointer active:bg-red-500/5 transition relative overflow-hidden"
