  ...
  return (
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-6">
      ...
      <div className="relative flex flex-col items-center gap-y-6 text-center max-w-sm">
        ...
        {joined && <p className="text-green-400 text-xs font-mono uppercase tracking-widest animate-pulse">✓ Entraste! A redirecionar...</p>}
        {isConnecting && !joined && <p className="text-neutral-500 text-xs font-mono uppercase tracking-widest animate-pulse">A entrar na sessão...</p>}
      </div>
    </div>
  );
}
